...
module.exports = {
  ...
  rules: {
    ...
    'no-descending-specificity': null, // 禁止在具有較高優先級的選擇器後出現被其覆蓋的較低優先級選擇器
    'function-url-quotes': 'always', // 要求或禁止 URL 的引號 "always(必須加上引號)"|"never(沒有引號)"
    'no-empty-source': null, // 關閉禁止空來源碼
    ...
    'selector-pseudo-class-no-unknown': [
      ...
      true,
      {
        ignorePseudoClasses: ['global', 'v-deep', 'deep'], // 忽略屬性，修改 Element 預設樣式時可使用
      },
    ],
  },
}
