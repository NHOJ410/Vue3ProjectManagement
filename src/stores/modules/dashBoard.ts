...
export const useDashBoardStore = defineStore(
  ...
  () => {
    ...
    // 飛機航線整理
    const flightRoutes = [
      { from: [121.565425, 25.033], to: [120.310663, 22.6273], name: '台北到高雄' },
      { from: [121.565425, 25.033], to: [120.673648, 24.147736], name: '台北到台中' },
      { from: [121.565425, 25.033], to: [120.227027, 22.999728], name: '台北到台南' },
      { from: [121.565425, 25.033], to: [119.566244, 23.566491], name: '台北到澎湖' },
      { from: [120.310663, 22.6273], to: [119.566244, 23.566491], name: '高雄到澎湖' },
      { from: [120.673648, 24.147736], to: [118.31786, 24.4404], name: '台中到金門' },
      { from: [120.673648, 24.147736], to: [119.566244, 23.566491], name: '台中到澎湖' },
      { from: [120.440663, 23.47511], to: [121.565425, 25.033], name: '嘉義到台北' }
    ]
